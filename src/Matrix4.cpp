...
void CMatrix4::CreateScale(float x, float y, float z)
{
	this->m11 = x;
	this->m22 = y;
	this->m33 = z;
...
void CMatrix4::CreateRotationX(float angle)
{
	float c = cosf(angle);
	float s = sinf(angle);
...
void CMatrix4::CreateRotationY(float angle)
{
	float c = cosf(angle);
	float s = sinf(angle);
...
void CMatrix4::CreateRotationZ(float angle)
{
	float c = cosf(angle);
	float s = sinf(angle);
...
void CMatrix4::Multiply(CMatrix4 &b)
{
	CMatrix4 a = *this;
